...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function ($) {
  ...
  $("#reset-password-form").submit(function () {
    ...
    if ($("#password").val() != $("#password-confirm").val()) {
      $("#reset-password-response").text("Passwords do not match! Please try again.");
    ...
    $.ajax({
      ...
      success: function success(response) {
        if (response.status == true) {
          ...
          $("#reset-password-response").text("The link is invalid or expired. Please try again.");
          $("#reset-password-response").slideDown();
          $("#loader").slideUp();
        }
      },
...
/***/ 3:
/*!********************************************!*\
  !*** multi ./_assets/js/password_reset.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
