...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function ($) {
  ...
  $("#registration-form").submit(function () {
    ...
    if ($("#password").val() != $("#password-confirm").val()) {
      $("#registration-response").text("Passwords do not match! Please try again.");
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (response.status == true) {
          ...
          console.log(JSON.stringify(response));
          $("#registration-response").text("Incorrect input values. Please try again.");
          $("#registration-response").slideDown();
          $("#loader").slideUp();
        }
      },
...
/***/ 2:
/*!**********************************!*\
  !*** multi ./_assets/js/auth.js ***!
  \**********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\Ind3Z\Desktop\TWIS NET\Front\_assets\js\auth.js */"./_assets/js/auth.js");
